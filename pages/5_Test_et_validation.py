...
def main():
    ...
    titres_onglets = ["En utilisant l'historique des incidents", 'En créant un nouvel incident']
...
##############################################################################################################################################################################################################################################################################################
    ...
    with onglet2:
        ...
        p = folium.Map(location=[lat_ward2, lon_ward2], zoom_start=9,zoom_control=False,scrollWheelZoom=False,dragging=False)
