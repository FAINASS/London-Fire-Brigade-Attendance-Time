...
def main():
    ...
    with onglet1:
        ...
        st.write (" ")
        st.markdown(f"<div style='text-align: left; color: black; background-color: #ff9800; padding: 10px; border-radius: 5px;'>⚠️ Le modèle n’a jamais été exposé à ces données, ni en entraînement ni en test, elles sont entièrement nouvelles.</div>", unsafe_allow_html=True)
        st.write(" ")
        ...
        st.write(f"Les pompiers ont mis {st.session_state['incident']['AttendanceTime]} pour intervenir. Cliquez sur le bouton en bas de la page pour voir notre prédiction")
