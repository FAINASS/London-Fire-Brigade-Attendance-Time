...
def main():
    ...
    La brigade des pompiers de Londres est le service d'incendie et de sauvetage le plus actif du Royaume-Uni. C'est le <span style='color:lightblue'>cinquième</span> plus grand corps de sapeurs-pompiers dans le monde avec <span style='color:lightblue'>5 992 employés</span> dont <span style='color:lightblue'>5 096 sapeurs-pompiers professionnels</span>.
    ...
    st.markdown("""
    Notre objectif est de prédire le temps de réponse des sapeurs-pompiers de Londres à partir des données de 2009 à 2023. Nous viserons un 
    ...
    etapes = ["Collecte des données", "Exploratory Data Analysis", "Data Preprocessing", "Modélisation","Test et validation","Conclusion"]
    emojis = ['📥', '📊', '🔧', '🏋️', '✅']
