...
def main():
   ...
   Nous avons décidé d’exclure les données de 2023, car l’année n’était pas encore terminée au moment de la collecte des données.
    ...
    ax[1].text(0, objectif_RMSE, f'Objectif: {objectif_RMSE} minutes', ha='center', va='bottom', color='red')
    ...
    st.write("""
      Quand notre modèle commet une erreur, elle est généralement d’environ 1.32 minutes.
