...
def main():
    ...
    if model_type == 'XGBRegressor':
       ...
       max_depth = my_expander2.slider('Max Depth', min_value=1, max_value=12, value=5)
    ...
    st.image(image_features, width=600)  # Ajustez la valeur de la largeur selon vos préférences
    
    st.subheader("Analyse des résidus :")
    image_residus = Image.open('Analyse_résidus.png')
    st.image(image_residus, width=600)  # Ajustez la valeur de la largeur selon vos préférences
    ...
    st.image(image_shap, width=600)  # Ajustez la valeur de la largeur selon vos préférences
